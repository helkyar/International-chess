...
/**
 * [https://github.com/lokeshgupta1981/Core-Java/tree/master/src/main/java/com/howtodoinjava/hashing/password/demo]
...
//PASSWORD ENCRYPTATION _______________________________________________________
    ...
    throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        SecretKeyFactory k = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA1");

        byte[] hash = k.generateSecret(spec).getEncoded();
...
// PASSWORD VALIDATION ________________________________________________________
    ...
    throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        PBEKeySpec spec = new PBEKeySpec(original.toCharArray(), 
